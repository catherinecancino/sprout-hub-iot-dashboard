...
export const translations = {
  en: {
    appName: "Sprout Hub",
    loadingSystem: "Loading Sprout Hub System...",
    ...
    howLibraryWorks: "How the Knowledge Library Works:",
    libraryRule1: "Upload a 'tomato_guide.pdf' →  'Tomato' profile",
    libraryRule2: "Upload a 'rice_manual.pdf' →  'Rice' profile",
    libraryRule3: "Easily switch crops using the dropdown on the dashboard",
    libraryRule4: "Alerts and the AI chatbot use the thresholds of the selected crop",
    libraryRule5: "Upload more documents to expand any existing crop profile",
    existingProfiles: "Existing Profiles (you can add documents to any of them):",
    noSpecificCrop: "No specific crop selected",
    docs: "docs",
  },
  
  fil: {
    appName: "Sprout Hub",
    loadingSystem: "Niloload ang Sprout Hub System...",
